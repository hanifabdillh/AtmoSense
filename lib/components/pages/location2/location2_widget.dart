              ...
              children: [
                Container(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: GetdevicelocationduaCall.call(),
                    builder: (context, snapshot) {
                      ...
                      final googleMapGetdevicelocationduaResponse =
                          snapshot.data!;

                      return Builder(builder: (context) {
                        final _googleMapMarker = functions.createLatLng(
                            GetdevicelocationduaCall.latitude(
                              googleMapGetdevicelocationduaResponse.jsonBody,
                            ),
                            GetdevicelocationduaCall.longitude(
                              googleMapGetdevicelocationduaResponse.jsonBody,
                            ));
                            ...
                            children: [
                              FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final containerGetdevicelocationduaResponse =
                                      snapshot.data!;
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      GetdevicelocationduaCall
                                                          .statusdevice(
                                                        containerGetdevicelocationduaResponse
                                                            .jsonBody,
                                                      ).toString(),
                                                      style:
                                                          FlutterFlowTheme.of(
