              ...
              children: [
                Container(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: GetlocationtigaCall.call(),
                    builder: (context, snapshot) {
                      ...
                      final googleMapGetlocationtigaResponse = snapshot.data!;

                      return Builder(builder: (context) {
                        final _googleMapMarker = functions.createLatLng(
                            GetlocationtigaCall.latitude(
                              googleMapGetlocationtigaResponse.jsonBody,
                            ),
                            GetlocationtigaCall.longitude(
                              googleMapGetlocationtigaResponse.jsonBody,
                            ));
                            ...
                            children: [
                              FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final containerGetlocationtigaResponse =
                                      snapshot.data!;
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      GetlocationtigaCall
                                                          .statusdevice(
                                                        containerGetlocationtigaResponse
                                                            .jsonBody,
                                                      ).toString(),
                                                      style:
                                                          FlutterFlowTheme.of(
